...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "UnloqOffers",
            url: "https://sdk.useunloq.com/ios/swift/UnloqOffers/2.2.9/UnloqOffers.xcframework.zip",
            checksum: "abd79dec0839cb5fd107615327b986119f0fe1828695d4b665336c20dfd88b99"
        ),
        .binaryTarget(
